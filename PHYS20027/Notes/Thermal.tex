...
We know $\Delta W$ from~\ref{eq:joule_thomson_expansion_work}, so
\begin{equation}
...
\begin{figure}[htpb]
	\centering
	\includesvg[width=0.9\columnwidth]{./energy_and_states.svg}
