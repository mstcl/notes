...
\begin{derivation}
	...
	\begin{equation}
		...
		=
		\Omega\left(E_0\right)\exponential{\left(-\frac{E_i}{k_B T}\right)}
	\end{equation}
	...
	\begin{equation}
		...
		\exponential\left(-\frac{E_i}{k_B T}\right)
	\end{equation}
...
\begin{equation}
	Z = \sum_i \exponential{\left(-\frac{E_i}{k_B T}\right)}
\end{equation}
...
\begin{definition}
	...
	\begin{equation}
		...
		P\left(E_i\right) =
		\frac{1}{Z}\exponential\left(-\frac{E_i}{k_B T}\right)
	\end{equation}
	where $Z$ is given as
	\begin{equation}
		Z = \sum_i g_i \exponential{\left(-\frac{E_i}{k_B T}\right)}
	\end{equation}
\end{definition}
...
\begin{example}
	...
	\begin{equation}
		Z = \sum_{J=0}^\infty
		\left(2J + I\right)\exponential\left(- \frac{J\beta \hbar^2}{2I}\left(J+1\right)\right)
	\end{equation}
\end{example}
...
\begin{equation}
	U = \sum_i P_i E_i = \frac{\sum_i E_i \exponential{\left(-\beta E_i\right)}}{\sum_i \exponential{\left(-\beta E_i\right)}}
\end{equation}
...
\begin{equation}
	f(v)\dd{v} \propto v^2
	\exponential\left(-\frac{mv^2}{2k_B T}\right)
\end{equation}
...
\begin{derivation}
	...
	\begin{equation}
		...
		\exponential{\left(-\beta \frac{mv^2}{2}\right)} = 1
	\end{equation}
	...
	\begin{equation}
		...
		\exponential{\left(-\frac{\beta mv^2}{2}\right)}
	\end{equation}
\end{derivation}
...
\begin{definition}
	...
	\begin{equation}
		...
		\left<N\right>
		=
		\frac{1}{\exponential{\left( \beta[\epsilon - \mu] - 1\right)}}
	\end{equation}
\end{definition}
...
\begin{derivation}
	...
	$\omega$
	\begin{equation}
		\dv{}{\omega}\left[\frac{\omega^3}{e_{\beta\hbar\omega} - 1}\right]
		=
		\left[\frac{3\omega^2}{e_{\beta\hbar\omega} - 1} - \frac{\omega^3\beta\hbar}{denom}\right].
	\end{equation}
...
\begin{derivation}
	...
	Thus,
	\begin{equation}
		\int^T_0\frac{1}{T}{\left(\pdv{U}{T}\right)}_{V}\dd{T}.
	\end{equation}
